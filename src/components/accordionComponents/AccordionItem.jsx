...
function AccordionItem(props) {
    ...
    const itemByType = (type, uuid, section, accordionUUID) => {
        switch (type) {
            case "appendixI": {
                return (
                <Card className="mb-4 mx-6 p-6">
                    The Acronyms Appendix will be generated by the transforms in the resulting document.
                </Card>
            )
            }
            ...
            case "terms": {
                ...
                return (<Terms uuid={uuid} accordionUUID={accordionUUID} title={termList.title} section={section}
                    open={termList.open} titleTooltip={tooltip} showAddButton={termList.showAddButton !== undefined ? termList.showAddButton : true}/>)
            }
            case "threats": {
