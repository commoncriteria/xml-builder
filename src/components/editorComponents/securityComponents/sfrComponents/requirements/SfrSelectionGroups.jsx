...
function SfrSelectionGroups(props) {
    ...
    const columnData = [
        { headerName: 'ID', field: 'id', editable: true, resizable: true, type: "Editor", flex: 1.5,
        ...
        { headerName: 'Text', field: 'text', editable: false, resizable: true, type: "Editor", flex: 2.5,
          headerTooltip: "The value of the selectable or assignment."},
        { headerName: 'Not Selectable', field: 'notSelectable', editable: true, resizable: true, type: "Checkbox", flex: 0.75,
          headerTooltip:  "Selections that must be viewable, but not selectable."},
        { headerName: 'Exclusive', field: 'exclusive', editable: true, resizable: true, type: "Checkbox", flex: 0.75,
    ...
    const handleDeleteSelectable = (newData, selectedData) => {
        ...
        selectedData.forEach((row) => {
            ...
            if (element.hasOwnProperty("isManagementFunction") && element.isManagementFunction
                && element.hasOwnProperty("managementFunctions") && element.managementFunctions.hasOwnProperty("rows")) {
    ...
    const generateRowData = () => {
        try {
            ...
            if (currentElement && currentElement.hasOwnProperty("selectables") && Object.entries(currentElement.selectables).length > 0) {
                let updatedRows = []
                Object.entries(currentElement.selectables).forEach(([key, value]) => {
    ...
    const updateSfrElement = (itemMap) => {
        const { elementUUID, componentUUID } = props
    ...
    const getSelectableCard = () => {
        ...
        return (
            element && element.selectableGroups && Object.keys(element.selectableGroups).length > 0 ?
                Object.entries(element.selectableGroups).map(([key, value]) => {
                    return (
                        <div
                            key={`${key}-selectables-card`}
                            className="mb-2 mx-[-16px]">
                            {value.hasOwnProperty("groups") ?
                                <SfrSelectionGroupCard
                                    sfrUUID={props.sfrUUID}
                                    componentUUID={props.componentUUID}
                                    elementUUID={props.elementUUID}
                        ...
                        <span className="min-w-full inline-flex items-baseline">
                            ...
                            <div className="w-[95%] justify-items-center">
                                <label
                                    ...
                                    className={`resize-none font-bold text-[14px] p-0 mt-1`}
                                >
                                    Selection Group
                                </label>
                            </div>
                    ...
                    { !collapse ?
                        <div className="py-2 w-full">
                            <div className="m-0 p-0 px-4 mt-2 w-full max-w-6xl mb-[-8px]">
                                ...
                                { collapseInnerTableSection === true ?
                                    <div className="relative border-2 border-t-0 rounded-b-md border-[#d0d5db] m-0 pt-6 pb-2"
                                        style={{top: '-20px'}}>
                                        <div className="p-2 px-4">
                                            <span className="min-w-full inline-flex items-baseline">
                                                <div className="w-[17%]">
                                                    <FormControl fullWidth color={styling.secondaryTextField}>
                                                        <InputLabel key="element-select-label">
                                                            Selectable Type
                                                        </InputLabel>
                                                ...
                                                <div className="w-[6%]">
                                                    <IconButton
                                                        ...
                                                        onClick={handleNewSelectableSubmit}
                                                        variant="contained"
                                                    >
                                                        <Tooltip
                                                            title={"Add Selectable"}
                                                            id={"addSelectableTooltip"}
                                                        >
                                                            <AddCircleIcon htmlColor={styling.secondaryColor} sx={icons.medium}/>
                                                        </Tooltip>
                                                    </IconButton>
                                                </div>
                                            </span>
                            ...
                            <CardTemplate
                                type={"section"}
                                header={
                                    <Tooltip id={"selectablesDescriptionTooltip"}
                                            ...
                                            <div className="px-4 pt-0 pb-2">
                                                <span className="min-w-full inline-flex items-baseline">
                                                    ...
                                                    <FormControl fullWidth color={styling.secondaryTextField}>
                                                        ...
                                                        >
                                                            <MenuItem
                                                                sx={styling.primaryMenu}
                                                                key={"Complex Selectable"}
                                                                value={"Complex Selectable"}
                                                            >
                                                                Complex Selectable
                                                            </MenuItem>
                                                            <MenuItem
                                                ...
                                                <div className="w-[68%] pl-2">
                                                    {selectableGroupType === "Complex Selectable" ?
                                                        <div>
                                                            <FormControl fullWidth>
                                                                <Tooltip
                                                                    id={complexSelectableID + "UserDefinedIDTooltip"}
                                                                    title={"User-defined ID for the new complex selectable."}
                                                                    arrow
                                                                >
                                                                    <TextField
                                                                        required
                                                        ...
                                                        <div>
                                                            <FormControl fullWidth>
                                                                <Tooltip
                                                                    id={selectableGroupID + "SfrGroupIDTooltip"}
                                                                    title={"User-defined ID for the new group."}
                                                                    arrow
                                                                >
                                                                    <TextField
                                                                        required
                                                ...
                                                <div className="w-[6%]">
                                                    <IconButton
                                                        ...
                                                        variant="contained">
                                                        <Tooltip
                                                            title={"Add Selectable Group"}
                                                            id={"addSelectableGroupTooltip"}
                                                        >
                                                            <AddCircleIcon htmlColor={styling.secondaryColor} sx={icons.medium}/>
                                                        </Tooltip>
                                                    </IconButton></div>
