...
import { handleSnackBarError, handleSnackbarTextUpdates } from "../../../../utils/securityComponents.jsx";
    ...
    <>
      <tr>
        ...
        <td className='pt-4 px-4 text-center align-middle'>
          <IconButton onClick={() => props.handleDeleteDialog(props)} variant='contained'>
            <Tooltip title={props.tableType === "objectives" ? "Delete Objective" : "Delete SFR"} id={props.uuid + "deleteObjectiveTooltip"}>
