...
function SecurityObjectivesTable(props) {
  ...
  return (
    <table>
      <caption>
        <span className='ctr' data-myid='' data-counter-type='ct-Table' id=''>
          Table <span className='counter'>1</span>
        </span>
      ...
      <tbody>
        ...
        <tr className='major-row'>
          <td rowSpan='4'>
            <a href='#T.NETWORK_ATTACK'>T.NETWORK_ATTACK</a>
            <br />
          </td>
          <td>
          ...
          <td>
            The threat <a href='#T.NETWORK_ATTACK'>T.NETWORK_ATTACK</a> is countered by <a href='#O.PROTECTED_COMMS'>O.PROTECTED_COMMS</a> as this provides for
        ...
        <tr>
          ...
          <td>
            The threat <a href='#T.NETWORK_ATTACK'>T.NETWORK_ATTACK</a> is countered by <a href='#O.INTEGRITY'>O.INTEGRITY</a> as this provides for integrity of
        ...
        <tr>
          ...
          <td>
            The threat <a href='#T.NETWORK_ATTACK'>T.NETWORK_ATTACK</a> is countered by <a href='#O.MANAGEMENT'>O.MANAGEMENT</a> as this provides for the
            ability to configure the{" "}
            <abbr className='dyn-abbr' title='Operating System'>
              <a href='#abbr_OS'>OS</a>
            </abbr>{" "}
            to defend against network attack.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            The threat <a href='#T.NETWORK_ATTACK'>T.NETWORK_ATTACK</a> is countered by <a href='#O.ACCOUNTABILITY'>O.ACCOUNTABILITY</a> as this provides a
            mechanism for the{" "}
            <abbr className='dyn-abbr' title='Operating System'>
              <a href='#abbr_OS'>OS</a>
            </abbr>{" "}
            to report behavior that may indicate a network attack has occurred.
          </td>
        </tr>
        <tr className='major-row'>
          <td rowSpan='2'>
            <a href='#T.NETWORK_EAVESDROP'>T.NETWORK_EAVESDROP</a>
            <br />
          </td>
          <td>
            <a href='#O.PROTECTED_COMMS'>O.PROTECTED_COMMS</a>
          ...
          <td>
            The threat <a href='#T.NETWORK_EAVESDROP'>T.NETWORK_EAVESDROP</a> is countered by <a href='#O.PROTECTED_COMMS'>O.PROTECTED_COMMS</a> as this
            provides for confidentiality of transmitted data.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            The threat <a href='#T.NETWORK_EAVESDROP'>T.NETWORK_EAVESDROP</a> is countered by <a href='#O.MANAGEMENT'>O.MANAGEMENT</a> as this provides for the
            ability to configure the{" "}
            <abbr className='dyn-abbr' title='Operating System'>
              <a href='#abbr_OS'>OS</a>
            </abbr>{" "}
        ...
        <tr className='major-row'>
          <td rowSpan='2'>
            <a href='#T.LOCAL_ATTACK'>T.LOCAL_ATTACK</a>
            <br />
          </td>
          <td>
            <a href='#O.INTEGRITY'>O.INTEGRITY</a>
          ...
          <td>
            The objective <a href='#O.INTEGRITY'>O.INTEGRITY</a> protects against the use of mechanisms that weaken the{" "}
            <abbr className='dyn-abbr' title='Target of Evaluation'>
              <a href='#abbr_TOE'>TOE</a>
            </abbr>{" "}
            with regard to attack by other software on the platform.
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            The objective <a href='#O.ACCOUNTABILITY'>O.ACCOUNTABILITY</a> protects against local attacks by providing a mechanism to report behavior that may
            indicate a local attack is occurring or has occurred.
          </td>
        </tr>
        <tr className='major-row'>
          <td rowSpan='1'>
            <a href='#T.LIMITED_PHYSICAL_ACCESS'>T.LIMITED_PHYSICAL_ACCESS</a>
            <br />
          </td>
          <td>
          ...
          <td>
            The objective <a href='#O.PROTECTED_STORAGE'>O.PROTECTED_STORAGE</a> protects against unauthorized attempts to access physical storage used by the{" "}
            <abbr className='dyn-abbr' title='Target of Evaluation'>
              <a href='#abbr_TOE'>TOE</a>
            </abbr>
            .
        ...
        <tr className='major-row'>
          <td rowSpan='1'>
            <a href='#A.PLATFORM'>A.PLATFORM</a>
            <br />
          </td>
          <td>
        ...
        <tr className='major-row'>
          <td rowSpan='1'>
            <a href='#A.PROPER_USER'>A.PROPER_USER</a>
            <br />
          </td>
          <td>
        ...
        <tr className='major-row'>
          <td rowSpan='1'>
            <a href='#A.PROPER_ADMIN'>A.PROPER_ADMIN</a>
            <br />
          </td>
          <td>
          ...
          <td>
            The operational environment objective <a href='#OE.PROPER_ADMIN'>OE.PROPER_ADMIN</a> is realized through{" "}
            <a href='#A.PROPER_ADMIN'>A.PROPER_ADMIN</a>.
          </td>
        </tr>
      </tbody>
