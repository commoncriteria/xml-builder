...
function DeleteSarSectionConfirmation(props) {
  ...
  return (
    <div>
      <Modal
        title={"Delete SAR Confirmation"}
        content={<div className='p-4 text-[14px] italic'>Are you sure you want to delete this entire SAR section and its sub-sections?</div>}
        open={props.open}
        handleOpen={() => {
          props.handleOpen();
        }}
